  ...
  return (
    <>
      <div className="sm:bg-black/30 gap-1 flex z-50 sm:justify-evenly sm:gap-0 justify-center items-center sm:backdrop-blur-md fixed sm:sticky top-0 right-0 left-0 w-full ">
        ...
        <div className="flex lg:hidden font-bold sm:bg-transparent sm:backdrop-blur-none bg-white/10 backdrop-blur-md items-center gap-1 px-2 py-2 border hover:shadow-[0_0_30px_rgba(34,197,94,0.7)] border-green-500 rounded-3xl text-green-500 text-[clamp(0.7rem,1vw,2rem)]">
